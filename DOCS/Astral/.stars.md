# Astral `.stars` Format Specification

# Shortcut.

If youre lazy, just use [astral-recipegen](https://github.com/Astaraxia-Linux/Astral/blob/main/astral-recipegen)

## Overview
After a sleepless night, 2 shot of espresso. The Astaraxia Devs has made this possible.
...
- **v3**: Detected by presence of `$PKG.Version = "3"` marker (recommended)
- **v2**: Detected by presence of `$PKG.` declarations without version marker
...
# Migrate v1/v2 to v3 format
astral-recipegen migrate package-old.stars v3
```
